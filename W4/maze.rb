  ...
  def initialize
    ...
    while i < x_cell_count 
      ...
      while j < y_cell_count
        n = @columns[i][j].north == nil ? "0" : "1"
        s = @columns[i][j].south == nil ? "0" : "1"
        w = @columns[i][j].west  == nil ? "0" : "1"
        e = @columns[i][j].east == nil ? "0" : "1"
        puts "Cell x:" + i.to_s + ", y:" + j.to_s + " north:" + n + " south:" + s + " east:" + e + " west:" + w
        j += 1
      end
      puts("------------- End of Column --------------")
      i += 1
